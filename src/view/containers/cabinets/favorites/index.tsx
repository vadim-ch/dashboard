...
class FavoritesCabinets extends React.PureComponent<IPropsComponents, {}> {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps as any)(FavoritesCabinets as any));
